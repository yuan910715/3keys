  ...
  methods: {   
    ...
    async sendCommit(){
     ...
     if(this.keyallmodeshow){
        ...
        if(!this.v7version){          
          if( (r1.funcCode==0x04&&r1.mediaExtraCode==0x02) || (r2.funcCode==0x04&&r2.mediaExtraCode==0x02) || (r3.funcCode==0x04&&r3.mediaExtraCode==0x02) || (rall.funcCode==0x04&&rall.mediaExtraCode==0x02) ){
